...
const Questions = (props) => {
    ...
    useEffect(() => {
        async function fetchList() {
            let response = await fetch('137.184.88.170/student/examsquestions/' + examid)
    ...
    const handleSubmission4 = async (e) => {
        e.preventDefault();
        let url = '137.184.88.170/teacher/questionsupload/';
        props.setprogress(50);
    ...
    const handleSubmission = async (e) => {
        ...
        let url = '137.184.88.170/teacher/examhostques/';
    ...
    //     const addques = async () => {
    //         try {
    //             const was = await fetch('137.184.88.170/teacher/examhostques/', {
    //                 method: 'POST',
    //                 headers: {
